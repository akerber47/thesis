...
\item If C has 1 gluing annulus, note that it must intersect a meridian disk
only once. Delete C and the attached page.
...
\item If P intersects a single page B, delete B.

\item If P intersects no pages, it lies entirely inside a spine C. Delete C and
all attached pages.
