...
\myfig{fig-bookex}{F:bookex}{Example of a book of $I$-bundles}
...
\myfig{fig-3arcs}{F:3arcs}{Lifting a standard set of 3 arcs in $\Si_{1,1}$}
...
\myfig{fig-boibexample}{F:ex1}{Construction of $S$}
