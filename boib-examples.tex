...
Let phi: S to S' be a proper pi1-injective map of compact connected surfaces
with boundary, and suppose that S is not the 2-sphere. Then phi is homotopic to
a finite-sheeted covering map.  Note that the converse holds more generally
- that is, any finite-sheeted covering is a proper pi1-injective map.
