%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Statement of the general problem}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Furthermore, it must not contain any parabolic elements at all. We can
therefore state the general problem as follows.

prob

Let Gamma be a Kleinian group of infinite volume. Does Gamma contain a surface
subgroup which is geometrically finite, and contains no parabolic elements?

end prob

We now discuss how to reduce this to a topological question.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Uniformization and pared 3-manifolds}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
See Canary-McCullough, Morgan, or Thurston for details and examples.
