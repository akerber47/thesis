...
\myfig{adjacentpolyhedra}{F:bdcomponent}{Intersections of $F$ with pages,
...
\myfig{adjacentpolyhedra}{F:buildingQ1}{Adding annuli to $Q_0$}
...
\myfig{adjacentpolyhedra}{F:finalgluing}{Attaching the $Q_a$ at $C$}
