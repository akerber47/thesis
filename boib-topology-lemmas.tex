...
2-sided in $M$. See Figure~\ref{F:boibdef} for an example.

\myfig{adjacentpolyhedra}{F:boibdef}{Example of a book of $I$-bundles}
...
\myfig{adjacentpolyhedra}{F:1ptcap}{Proof of Proposition~\ref{P:1ptcap}}
...
\begin{lemma}[Surface decomposition lemma]
