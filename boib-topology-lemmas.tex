...
made, every piece of S is pi1-injective. % TODO those stupid annuli!
...
every piece S' must be an annulus. These annuli are pi1-injective. This proves
(2). % TODO fix rest of 2 for change
...
a connected closed surface.  Place S and P in minimal position as above. Then
S is a (QF) surface if and only if the following criterion holds:

Construct a lifted pared pattern as follows. For each spine C, each component
S' of S cap C is an immersed annulus parallel to a multiple of the binding
annuli.  The two components of 
% TODO finish statement here
