...
Let B be an I-bundle. B is irreducible and has incompressible boundary.
...
page or spine of M. For each page or spine X cin M, we claim that S cap X is
a union of pieces which are either pi1-injective or homotopic into bd X.
Consider an arbitrary combonent of S cap X which is not 
