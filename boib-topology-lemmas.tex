...
incompressible (ie $\pi_1$-injective) and not boundary parallel in $M$. This
reflects the origin of the book of $I$-bundles construction from a relative JSJ
decomposition. Note that it is possible to construct pathological books of
$I$-bundles where this is not the case, with sufficiently complex repeated
gluings to the same few spines.
