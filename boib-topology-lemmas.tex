...
nonelementary hyperbolic.  Combining all these cases, we only want to consider
base surfaces with negative Euler characteristic.
...
Let $M$ be a book of $I$-bundles. Recall we assumed that $\bd M$ is
incompressible. Then in fact all the binding annuli are incompressible (ie
$\pi_1$-injective), boundary incompressible, and not boundary parallel in $M$.
