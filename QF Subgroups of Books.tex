...
% IS THIS CORRECT? Check Canary-McCullough and Morgan. This might allow me to
% simplify my argument considerably... I may have just paraphrased it wrong...
% ie does anything apply to the annular components cuttin gup the dM boundaries
% or do I really just mean to say "every component has negative Euler
% characteristic, except the ones which are T2, and that T2 is in the pared
% structure" TODO XXX
\end{enumerate}
...
%covers of the punctured torus (corresponding to the 3 nontrivial maps of pi\Si_{1,1}
