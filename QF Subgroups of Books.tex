...
may traverse one or more meridians, but this irrelevant for our proof)
...
Fix x1 to be our basepoint, and let alpha be a longitude of C through x1. Using
LERF, choose a map phi_C,B,A1,A2 such that phi_C,B,A1,A2(gamma) notin
phi_C,B,A1,A2(<alpha>). Repeat this construction for each A1,A2 and each B,C
with multiple gluings. Let phi be the product of all these, and M' the
associated regular cover, just like above.

We claim that M' satisfies (2).
