...
\item Each gluing annulus on a spine is parallel to a simple longitude.

\item Each page is glued to a given spine at most once.

\item Each page is a trivial I-bundle over an oriented surface.
...
power, lift to an annulus which traverses C' exactly once. By regularity of the
cover this implies that the union of all lifts of these annuli is a union of
annuli traversing C' exactly once. Since this argument holds for any C'
upstairs and C downstairs, M' satisfies (1). Note that any further
finite-sheeted cover of M' will also satisfy (1), by looking locally at the
lifting of gluing annuli above each spine.
