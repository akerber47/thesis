...
%TODO
\textbf{TODO there are other base cases of the reduction too - what if we get
a spine w no pages, or a closed surface page without spines. NOT ALL closed
surface page without spine cases are in (B)! Need to clarify.}
