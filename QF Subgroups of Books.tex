...
identify the cases that obviously can't have a surface satisfying \eqref{E:qf}. Then
...
perturb slightly to obtain a surface satisfying \eqref{E:qf} downstairs (since it
...
%% XXX this tex looks hideous ... need to find a better way to do this. Look
% in my tex reference book etc etc
