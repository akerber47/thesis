...
\item The underlying topological manifold is a compact connected orientable
...
%FIXME set of books of I-bundles? bc might break into multiple pieces ... ugh
%what a mess...
...
Note that the non-reduced case is covered by the earlier proposition. If the
reduction process outlined there produces one or more reduced books of
I-bundles, we can study those. If not, and it terminates in an empty set, then
there cannot be a QF surface.
...
\item Each gluing annulus on a spine is a simple longitude, and each page is an
oriented surface.
...
\textbf{Was earlier}: If any pages are twisted I-bundles or I-bundles over
nonorientable surfaces, using LERF we can construct a finite cover of M where
all pages are covered by trivial I-bundles over orientable surfaces.
