...
Let M be a compact n-manifold such that pi1M is LERF. Let C be a compact
(n-1)-complex, and phi colon C immerse M a pi1-injective immersion.  Then there
exists a finite sheeted cover M' to M such that phi lifts to a map phi' colon
C into M' which is homotopic to an embedding.
...
\textbf{ TODO This proof needs work.}
...
... something. \textbf{ TODO} % TODO figure this out.
...
\textbf{ TODO now that I look at this thing, it's kind of a mess... should probably
