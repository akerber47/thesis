...
phiC(alpha),phiC(alpha^2),dots,phiC(alpha^{k-1}) notin phiC(<alpha^k>). Let phi
colon pi1M to G = prod GC be the product of all these maps of the appropriate
orders for each C. Again, we elide changes of basepoint. Let M' be the
associated regular cover of M.

We claim that M' satisfies (1).
