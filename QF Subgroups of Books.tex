...
longitude of, that is, a page can wrap multiple times around a spine. However,
all the Aij' must be disjoint and parallel, or the result of gluing will not be
a manifold.
...
A book of I-bundles M is reduced if it satisfies the following conditions.

- M has incompressible boundary.

- Each page is a trivial I-bundle over an orientable surface of negative Euler
characteristic.

- Each spine contains at least 3 gluing annuli.
